...
{
    public static TheoryData<string, string, string, long, string, string, int, double> ModelPins => new()
    {
        {
        ...
        double presencePenalty)
    {
        ...
        Assert.Equal(speculativeDraftMaxTokens, model.Recipe.SpeculativeDraftMaxTokens);
        Assert.Equal(presencePenalty, model.Recipe.Sampling.PresencePenalty);
    ...
    public void EveryModelUsesFullNativeContextAndF16KvCache()
    {
        Assert.All(
            ...
            model =>
            {
                ...
                Assert.Equal(512, model.Recipe.BatchTokens);
    ...
    public void EveryModelUsesThinkingSamplerDefaults()
    {
        Assert.All(
            ...
            model =>
            {
                Assert.Equal(1.0, model.Recipe.Sampling.Temperature);
